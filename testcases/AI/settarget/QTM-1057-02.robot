...
** Test Cases ***
Verify that system able to display correctly when Sales approver or Super user approve the target adjustment successfully
    [Tags]          QTM-1057-02
    ...
    settarget_page.Update csv file before import file settarget     
        ...     ${settarget['csv_file']['QTM-1057']}
        ...     ${settarget['csv_1057']['row']}
        ...     ${settarget['csv_1057']['col']}
    ...
    common.Choose csv file  ${folder_name['csv_data']}        ${settarget['csv_file']['QTM-1057']}      ${file_extension['csv']}   
    ...
    settarget_page.Verify sale target is displayed correctly  
                ...
                ...     ${settarget['csv_1057']['row']}
                ...     ${settarget['csv_1057']['col']}
                ...     ${settarget['csv_1057']['target_year']}
                ...     ${settarget['csv_1057']['target_month']}
    ...
    # Super user approve
    login_feature.User login via email and password     ${account['sale_approver']['acc_01']['username']}        ${account['sale_approver']['acc_01']['password']}
    common.Get customer token    ${account['sale_approver']['acc_01']['username']}        ${account['sale_approver']['acc_01']['password']}
    main_feature.Verify saleuser login success
    main_page.User select AI feature
    AI_feature.Verify AI page is displayed correctly for user   
    AI_page.User clicks on menu         ${menu_name['ai_page']['menu_settarget']}
    ...
    common.Select categories name           name_category=${MCH3_category['all_category']}
    common.Click button using name          ${button_name['btn_apply']}
    common_feature.Select action after upload file csv      ${button_name['btn_approve']}
    settarget_page.Verify sale target is displayed correctly  
                ...     ${settarget.current_cell}
                ...     ${settarget['csv_file']['QTM-1057']}   
                ...     ${settarget['csv_1057']['row']}
                ...     ${settarget['csv_1057']['col']}
                ...     ${settarget['csv_1057']['target_year']}
                ...
                ...     background_color=rgba(0, 125, 255, 0.06)

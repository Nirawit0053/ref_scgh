...
** Test Cases ***
Verify that sale user unable to import file success by case import CSV but not correct template
    [Tags]          QTM-1053-03     BUG
    ...
    common.Choose csv file                              ${folder_name['csv_data']}      ${QTM_1053_03['file_name']}     ${file_extension['csv']}

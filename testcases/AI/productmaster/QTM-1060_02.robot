...
** Test Cases ***
Verify that user unable to import successfully by case import csv but not correct template 
    [Tags]          QTM-1060-02
    [Setup]         BuiltIn.Run Keyword    common.Get customer token    ${account['superuser']['acc_03']['username']}        ${account['superuser']['acc_03']['password']}
    ...
    common.Choose csv file                                                  ${folder_name['productmaster']}      ${QTM_1060_02['file_name']}     ${file_extension['csv']}

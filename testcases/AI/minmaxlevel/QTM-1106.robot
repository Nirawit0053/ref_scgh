...
Verify User can came back to save draft
    ...
    common.Input article Number     ${QTM_1106['article_number']}
    ...
    common.Choose csv file  ${folder_name['csv_data']}    ${QTM_1106['csv_file']}      ${file_extension['csv']}
    ...
    common.Click button using name            ${button_name['btn_apply']}
    common.Click button using name          ${button_name['btn_edit']}
    min_max_level.Verify min max by code and store value in table should be display blue color      ${QTM_1106['store'][0]}      ${QTM_1106['store'][1]}    ${QTM_1106['store'][2]}

...
Verify User can came back to save draft
    ...
    common.Input article Number     ${QTM_1118['article_number']}
    ...
    common.Choose csv file  ${folder_name['csv_data']}    ${QTM_1118['csv_file']}      ${file_extension['csv']}
    ...
    common.Click button using name            ${button_name['btn_apply']}
    common.Click button using name          ${button_name['btn_edit']}
    min_max_level.Verify min max by code and store value in table should be display blue color      ${QTM_1118['store_1'][0]}      ${QTM_1118['store_1'][1]}    ${QTM_1118['store_1'][2]}
    min_max_level.Verify min max by code and store value in table should be display blue color      ${QTM_1118['store_2'][0]}      ${QTM_1118['store_2'][1]}    ${QTM_1118['store_2'][2]}
